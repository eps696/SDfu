...
There is also a [similar repo](https://github.com/eps696/SD), based on the [CompVis] and [Stability AI] libraries (mey be less up-to-date).  
...
```
python src/gen.py -im _in/something.jpg -t "<line-art>"
```
...
Huge respect to the people behind [Stable Diffusion], [HuggingFace], and the whole open-source movement.
